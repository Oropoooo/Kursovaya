<?php 
    ...
    use emails as LoginEmail;
    require_once('phpmailer/PHPMailerAutoload.php');

    $email = LoginEmail\LoginEmail::$email;
    $mail = new PHPMailer;
    $mail->CharSet = 'utf-8';
    ...
    $mail->Body    = 'Email: ' . $email . '<br> Дата и время: ' . $datetime_formated. '.' . '<br> Выбранные столики: ' . $tables;
    $mail->AltBody = '';
...
<?php
    ...
    $mail->Subject = 'Заявка на бронирование';
    $mail->Body    = 'Вы оставили заявку на бронирование. <br> Email: ' . $email . '<br> Дата и время: ' . $datetime_formated. '.' . '<br> Выбранные столики: ' . $tables;
    $mail->AltBody = '';
